...
public class ContagemDeCedulas {
    public static void main(String[] args) throws IOException {
        ...
        out.println(notasInseridas);
        out.println(  notas100 + " nota(s) de R$ 100,00");
        out.println(  notas50 + " nota(s) de R$ 50,00");
        out.println(  notas20 + " nota(s) de R$ 20,00");
        out.println(  notas10 + " nota(s) de R$ 10,00");
        out.println(  notas5 + " nota(s) de R$ 5,00");
        out.println(  notas2 + " nota(s) de R$ 2,00");
        out.println(  notas1 + " nota(s) de R$ 1,00");
